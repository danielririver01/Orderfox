...
- **Reference:** [/memories/repo/authentication-policy.md](/memories/repo/authentication-policy.md)
...
- **Reference:** [/docs/RATE_LIMITING_INTEL.md](docs/RATE_LIMITING_INTEL.md)
...
- [Authentication Policy](memories/repo/authentication-policy.md) — Trial auto-create flow
- [Codebase Guide](memories/repo/orderfox-codebase-guide.md) — Detailed architecture reference
...
Generated by Copilot Agent Customization | *Last updated: 2026-06-04*
