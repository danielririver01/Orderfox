...
def upgrade():
    ...
    op.execute("UPDATE reward_claims SET short_code = 'mig-' || id::text WHERE short_code IS NULL OR short_code = ''")
    op.execute("ALTER TABLE reward_claims ALTER COLUMN short_code SET NOT NULL")
    try:
